...
<html lang="en">
    <head>
        ...
        <div id="wrapper">
            <div id="menu">
                <p class="welcome">Welcome, <b class="badge badge-success"><?php echo $_SESSION['username']; ?></b></p>
        ...
        ?></div>
            ...
            <form name="message" action=".">
                ...
                <input name="submitmsg" type="submit"  id="submitmsg" class="btn btn-success" value="enviar" />
            </form>
        </div>
