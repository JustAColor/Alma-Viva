...
<head>
    ...
    <link rel="stylesheet" href="style/css/slide.css">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="jumbotron">
                                    <h1 class="display-4">Bienvenido!</h1>
                                        <p class="lead">.</p>
                                        <hr class="my-4">
                                            <p>quieres morir pincha en el enlace.</p>
                            ...
                            <ol class="carousel-indicators">
                                ...
                                <div class="carousel-item active">
                                    <img src="img/1.png" style="height:500px;" class="d-block w-100" alt="...">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 center-block bg-success container-block"></div>
                                <div class="col-md-4 center-block bg-success container-block"></div>
                                <div class="col-md-4 center-block bg-success container-block"></div>
                            </div>
                            <div class="row">
...
<div class="footer-copyright text-center py-3">
    <p class="text-light"> © 2019 Copyright: a algun idiota de internet</p>
</div>
<!-- Copyright -->
